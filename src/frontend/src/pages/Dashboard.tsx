                                ...
                                <Grid item xs={12} sm={6} md={3} key={index}>
                                    <Card className={styles.card}>
                                        <CardContent>
                                            ...
                                            <Typography variant="subtitle1" className={styles.cardLabel}>{item.label}</Typography>
                                            <Typography variant="body2" className={styles.cardChange}>{item.change} from yesterday</Typography>
                                        </CardContent>
                                    </Card>
                                </Grid>
                            ))}
                    ...
                    <Box className={styles.container2}>
                        ...
                        <Box className={styles.legend}>
                            <Box className={styles.legendItem}>
                                <Box className={styles.legendDot} style={{ backgroundColor: 'var(--accent-color)' }} />
                                <Typography variant="body2">Volume</Typography>
                            </Box>
                            <Box className={styles.legendItem}>
                                <Box className={styles.legendDot} style={{ backgroundColor: '#dfe6e9' }} />
                                        ...
                                        <TableRow key={index}>
                                            ...
                                            <TableCell>
                                                <Box display="flex" alignItems="center">
                                                    ...
                                                    <Box minWidth={35}>
                                                        <Typography variant="body2" color="textSecondary">{`${issue.popularity}%`}</Typography>
                                                    </Box>
                                                </Box>
                                            </TableCell>
                                            <TableCell>
